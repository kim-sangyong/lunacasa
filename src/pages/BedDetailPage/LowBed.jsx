...
const LowBed = () =>  {
    return(
        <>
        <Helmet>
            <title>저상형 침대 - 루나카사</title>
                <meta name="description" content="자취인들의 편한 루나카사의 저상형 침대를 만나보세요."/>
                <meta name="keywords" content="루나카사 가구, 루나카사 인테리어, 루나카사 저상형 침대, LUNACASA 가구, 
                LUNACASA 인테리어, LUNACASA 저상형 침대, 유럽 가구, 이태리 가구, 편안한 가구, 합리적인 가격, 
                ...
                {/* 공유할 URL을 설정합니다. */}
                <meta meta property="og:url" content="https://raw.githubusercontent.com/kim-sangyong/test/main/LowFloorBed.png"/>

                {/* 트위터 */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="LUNACASA - 저상형 침대." />
                <meta name="twitter:description" content="저상형 침대를 만나보세요. 차별화된 침대를 만나게 됩니다." />
                <meta name="twitter:image" content="https://raw.githubusercontent.com/kim-sangyong/test/main/LowFloorBed.png" />
        </Helmet>
